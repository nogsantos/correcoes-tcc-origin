...
Um armazém de dados, em inglês \textit{data mart} sigla \textit{DM}, pode ser definido como um conjunto de dados destinado a auxiliar em decisões de negócios. Seus dados não são voláteis, pois uma vez carregados não podem mais sofrer alterações.
